//
//  GuidanceSaddlePositionView.swift
...
struct GuidanceSaddlePositionView: View {
    ...
    var body: some View {
        VStack {
            ...
            TabView {
                VStack {
                    Text("Saddle Guidance 1 Headline")
                        .font(.title)
                ...
                VStack {
                    Text("Saddle Guidance2 Headline")
                        .font(.title)
                ...
                VStack {
                    Text("Saddle Guidance 3 Headline")
                        .font(.title)
