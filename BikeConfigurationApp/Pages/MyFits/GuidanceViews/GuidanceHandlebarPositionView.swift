//
//  GuidanceHandlebarPositionView.swift
...
struct GuidanceHandlebarPositionView: View {
    ...
    var body: some View {
        VStack {
            ...
            TabView {
                VStack {
                    Text("Handlebar Guidance 1 Headline")
                        .font(.title)
                ...
                VStack {
                    Text("Handlebar Guidance2 Headline")
                        .font(.title)
                ...
                VStack {
                    Text("Handlebar Guidance 3 Headline")
                        .font(.title)
